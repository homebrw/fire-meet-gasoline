...
export const FORM_HELP_TEXT = {
  ...
  exceptions: {
    ruleId: "Choisissez la règle à laquelle cette exception s'applique. La personne concernée est automatiquement celle de la règle.",
    type: "« Présence exceptionnelle » : l'enfant est avec ce parent sur la période, même si la règle dit non. « Absence exceptionnelle » : l'enfant n'est pas avec ce parent sur la période, même si la règle dit oui.",
    startAt: "Début de la plage concernée par l'exception.",
    endAt: "Fin de la plage concernée par l'exception.",
