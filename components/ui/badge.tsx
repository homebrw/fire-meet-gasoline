  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        damien: "border-transparent bg-blue-100 text-blue-800",
        ma: "border-transparent bg-pink-100 text-pink-800",
        available: "border-transparent bg-green-100 text-green-800",
        transition: "border-transparent bg-orange-100 text-orange-800",
      },
    },
    defaultVariants: {
      variant: "default",
